...
Este projeto foi desenvolvido como parte da Atividade 8 da disciplina Fundamentos de Inteligência Artificial, cursada no primeiro semestre, com foco na utilização da biblioteca Hugging Face.
